	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.moves = {MOVE_FLAMETHROWER, MOVE_SUNNY_DAY, MOVE_THUNDER_PUNCH, MOVE_CROSS_CHOP},
					.hpEV = 100,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 210,
				...
				},
				{
					...
					.moves = {MOVE_ROCK_SLIDE, MOVE_SEISMIC_TOSS, MOVE_SWAGGER, MOVE_CROSS_CHOP},
					.hpEV = 100,
					.attackEV = 200,
					.defenseEV = 0,
					.speedEV = 210,
				...
				},
				{
					...
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_SURF, MOVE_THUNDER_WAVE, MOVE_FLAMETHROWER, MOVE_PSYCHIC},
					.hpEV = 100,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.moves = {MOVE_FLAMETHROWER, MOVE_SUPERPOWER, MOVE_SHADOW_BALL, MOVE_AGILITY},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 200,
					.speedEV = 0,
				...
				},
				{
					...
					.moves = {MOVE_FLAMETHROWER, MOVE_LIGHT_SCREEN, MOVE_SOFT_BOILED, MOVE_MINIMIZE},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					...
					.heldItem = ITEM_STICK,
					.moves = {MOVE_BRICK_BREAK, MOVE_SWORDS_DANCE, MOVE_SKY_ATTACK, MOVE_RETURN},
					.hpEV = 100,
					.attackEV = 100,
					.defenseEV = 100,
					.speedEV = 100,
				...
				},
				{
					...
					.moves = {MOVE_SUBSTITUTE, MOVE_THUNDERBOLT, MOVE_LIGHT_SCREEN, MOVE_PSYCHIC},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
			...
			.mons = {
				{
					...
					.moves = {MOVE_BOUNCE, MOVE_OVERHEAT, MOVE_HYPNOSIS, MOVE_HI_JUMP_KICK},
					.hpEV = 100,
					.attackEV = 100,
					.defenseEV = 0,
					.speedEV = 110,
				...
				},
				{
					...
					.moves = {MOVE_CONFUSE_RAY, MOVE_WILL_O_WISP, MOVE_HEAT_WAVE, MOVE_CALM_MIND},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 200,
				...
				},
				{
					.species = SPECIES_BLISSEY,
					.heldItem = ITEM_LEFTOVERS,
					.moves = {MOVE_LIGHT_SCREEN, MOVE_MINIMIZE, MOVE_SOFT_BOILED, MOVE_FLAMETHROWER},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					...
					.heldItem = ITEM_LEFTOVERS,
					.moves = {MOVE_IRON_TAIL, MOVE_ROCK_SLIDE, MOVE_PROTECT, MOVE_SKY_ATTACK},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					...
					.heldItem = ITEM_CHARCOAL,
					.moves = {MOVE_HEAT_WAVE, MOVE_EXTREME_SPEED, MOVE_CRUNCH, MOVE_PROTECT},
					.hpEV = 210,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 200,
				...
				},
				{
					...
					.heldItem = ITEM_WHITE_HERB,
					.moves = {MOVE_OVERHEAT, MOVE_OUTRAGE, MOVE_ROCK_SLIDE, MOVE_SMOKESCREEN},
					.hpEV = 100,
					.attackEV = 110,
					.defenseEV = 0,
					.speedEV = 100,
			...
			.mons = {
				{
					...
					.moves = {MOVE_RETURN, MOVE_ROCK_TOMB, MOVE_IRON_TAIL, MOVE_DOUBLE_TEAM},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					...
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_PROTECT, MOVE_RETURN, MOVE_ROCK_SLIDE, MOVE_FAKE_OUT},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					...
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_SKY_ATTACK, MOVE_SHARPEN, MOVE_DOUBLE_EDGE, MOVE_AGILITY},
					.hpEV = 100,
					.attackEV = 210,
					.defenseEV = 100,
					.speedEV = 0,
				...
				},
				{
					...
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_STEEL_WING, MOVE_SKY_ATTACK, MOVE_MEGA_KICK, MOVE_TOXIC},
					.hpEV = 100,
					.attackEV = 110,
					.defenseEV = 100,
					.speedEV = 100,
				...
				},
				{
					...
					.heldItem = ITEM_LUM_BERRY,
					.moves = {MOVE_REST, MOVE_CRUNCH, MOVE_BRICK_BREAK, MOVE_DOUBLE_EDGE},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					...
					.heldItem = ITEM_SHELL_BELL,
					.moves = {MOVE_HYPNOSIS, MOVE_DREAM_EATER, MOVE_REFLECT, MOVE_PSYCHIC},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					...
					.heldItem = ITEM_SHELL_BELL,
					.moves = {MOVE_EXTREME_SPEED, MOVE_SURF, MOVE_SHOCK_WAVE, MOVE_TOXIC},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					...
					.heldItem = ITEM_SHELL_BELL,
					.moves = {MOVE_SUNNY_DAY, MOVE_FLAMETHROWER, MOVE_LOVELY_KISS, MOVE_BODY_SLAM},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_PORYGON2,
					.heldItem = ITEM_LEFTOVERS,
					.moves = {MOVE_THUNDERBOLT, MOVE_CONVERSION_2, MOVE_ICE_BEAM, MOVE_RECOVER},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
			...
			.mons = {
				{
					...
					.moves = {MOVE_ICE_BEAM, MOVE_SWORDS_DANCE, MOVE_TAUNT, MOVE_FAINT_ATTACK},
					.hpEV = 200,
					.attackEV = 0,
					.defenseEV = 50,
					.speedEV = 210,
				...
				},
				{
					.species = SPECIES_ALAKAZAM,
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_FIRE_PUNCH, MOVE_RECOVER, MOVE_PSYCHIC, MOVE_ICE_PUNCH},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 255,
				...
				},
				{
					...
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_MEGA_KICK, MOVE_ENDEAVOR, MOVE_DIG, MOVE_TRIPLE_KICK},
					.hpEV = 100,
					.attackEV = 210,
					.defenseEV = 0,
					.speedEV = 200,
				...
				},
				{
					...
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_LIGHT_SCREEN, MOVE_RETURN, MOVE_SHADOW_BALL, MOVE_PSYCHIC},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					...
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_SKY_ATTACK, MOVE_GIGA_DRAIN, MOVE_CONFUSE_RAY, MOVE_PSYCHIC},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 100,
				...
				},
				{
					.species = SPECIES_MR_MIME,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_PSYCHIC, MOVE_THUNDERBOLT},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 200,
					.speedEV = 200,
			...
			.mons = {
				{
					...
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_FIRE_PUNCH, MOVE_HYPNOSIS, MOVE_PSYCHIC, MOVE_CALM_MIND},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 255,
				...
				},
				{
					...
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_PROTECT, MOVE_CROSS_CHOP, MOVE_SCARY_FACE, MOVE_ROCK_SLIDE},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_HOUNDOOM,
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_HEAT_WAVE, MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_PROTECT},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 255,
				...
				},
				{
					.species = SPECIES_PRIMEAPE,
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_CROSS_CHOP, MOVE_SWAGGER, MOVE_SEISMIC_TOSS, MOVE_DOUBLE_TEAM},
					.hpEV = 100,
					.attackEV = 110,
					.defenseEV = 100,
					.speedEV = 100,
				...
				},
				{
					...
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_MEGAHORN, MOVE_EARTHQUAKE, MOVE_COUNTER, MOVE_CROSS_CHOP},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 200,
					.speedEV = 0,
			...
			.mons = {
				{
					...
					.moves = {MOVE_THUNDER_PUNCH, MOVE_CONFUSE_RAY, MOVE_FLAMETHROWER, MOVE_PSYCHIC},
					.hpEV = 210,
					.attackEV = 30,
					.defenseEV = 30,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_CLEFABLE,
					.heldItem = ITEM_LAX_INCENSE,
					.moves = {MOVE_ATTRACT, MOVE_CHARM, MOVE_RETURN, MOVE_FLASH},
					.hpEV = 210,
					.attackEV = 210,
					.defenseEV = 30,
					.speedEV = 0,
				...
				},
				{
					...
					.heldItem = ITEM_LAX_INCENSE,
					.moves = {MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_ICE_BEAM, MOVE_LOVELY_KISS},
					.hpEV = 210,
					.attackEV = 0,
					.defenseEV = 45,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_TOGETIC,
					.heldItem = ITEM_LAX_INCENSE,
					.moves = {MOVE_PSYCHIC, MOVE_YAWN, MOVE_ANCIENT_POWER, MOVE_DOUBLE_TEAM},
					.hpEV = 210,
					.attackEV = 210,
					.defenseEV = 45,
					.speedEV = 0,
				...
				},
				{
					...
					.heldItem = ITEM_LAX_INCENSE,
					.moves = {MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT, MOVE_SWEET_KISS, MOVE_SURF},
					.hpEV = 210,
					.attackEV = 0,
					.defenseEV = 45,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_JYNX,
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_PSYCHIC, MOVE_LOVELY_KISS, MOVE_SHADOW_BALL, MOVE_ICE_BEAM},
					.hpEV = 110,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_CHARIZARD,
					.heldItem = ITEM_SCOPE_LENS,
					.moves = {MOVE_FIRE_BLAST, MOVE_EARTHQUAKE, MOVE_AIR_CUTTER, MOVE_OUTRAGE},
					.hpEV = 200,
					.attackEV = 200,
					.defenseEV = 0,
					.speedEV = 110,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_FLAREON,
					.heldItem = ITEM_SILK_SCARF,
					.moves = {MOVE_IRON_TAIL, MOVE_FIRE_BLAST, MOVE_SHADOW_BALL, MOVE_DOUBLE_EDGE},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
				...
				},
				{
					...
					.heldItem = ITEM_WHITE_HERB,
					.moves = {MOVE_SUPERPOWER, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_COUNTER},
					.hpEV = 110,
					.attackEV = 100,
					.defenseEV = 100,
					.speedEV = 100,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					...
					.heldItem = ITEM_LEFTOVERS,
					.moves = {MOVE_HYDRO_PUMP, MOVE_EARTHQUAKE, MOVE_SUBMISSION, MOVE_COUNTER},
					.hpEV = 110,
					.attackEV = 100,
					.defenseEV = 100,
					.speedEV = 100,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.moves = {MOVE_TOXIC, MOVE_FLY, MOVE_DOUBLE_TEAM, MOVE_REST},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					...
					.heldItem = ITEM_LEFTOVERS,
					.moves = {MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_RETURN, MOVE_ROCK_TOMB},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_SLUDGE_BOMB, MOVE_TWINEEDLE, MOVE_BRICK_BREAK, MOVE_SWORDS_DANCE},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					...
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_HYPNOSIS, MOVE_PROTECT, MOVE_SIGNAL_BEAM, MOVE_AIR_CUTTER},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					...
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_TOXIC, MOVE_SPIKE_CANNON, MOVE_PROTECT, MOVE_TWINEEDLE},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
			...
			.mons = {
				{
					.species = SPECIES_HITMONLEE,
					.heldItem = ITEM_SCOPE_LENS,
					.moves = {MOVE_ROCK_TOMB, MOVE_HI_JUMP_KICK, MOVE_ROCK_SLIDE, MOVE_PROTECT},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_GOLEM,
					.heldItem = ITEM_SCOPE_LENS,
					.moves = {MOVE_BRICK_BREAK, MOVE_ROCK_SLIDE, MOVE_DIG, MOVE_PROTECT},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_PINSIR,
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_ROCK_SLIDE, MOVE_MEGAHORN, MOVE_SUBMISSION, MOVE_PROTECT},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_HITMONCHAN,
					.heldItem = ITEM_LEFTOVERS,
					.moves = {MOVE_MACH_PUNCH, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH, MOVE_PROTECT},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
			...
			.mons = {
				{
					...
					.heldItem = ITEM_FOCUS_BAND,
					.moves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_HIDDEN_POWER, MOVE_THUNDER_WAVE},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					...
					.moves = {MOVE_NONE, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_NONE},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_FLAREON,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_SUPERPOWER, MOVE_FLAMETHROWER, MOVE_SHADOW_BALL, MOVE_IRON_TAIL},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_VAPOREON,
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_GROWL, MOVE_ICE_BEAM, MOVE_HELPING_HAND, MOVE_SURF},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 255,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.heldItem = ITEM_SOFT_SAND,
					.moves = {MOVE_EARTHQUAKE, MOVE_SURF, MOVE_BLIZZARD, MOVE_BRICK_BREAK},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 255,
				...
				},
				{
					...
					.heldItem = ITEM_SOFT_SAND,
					.moves = {MOVE_EARTHQUAKE, MOVE_BLIZZARD, MOVE_ROCK_SLIDE, MOVE_BODY_SLAM},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.heldItem = ITEM_PETAYA_BERRY,
					.moves = {MOVE_PSYCHIC, MOVE_ICE_BEAM, MOVE_SURF, MOVE_RECOVER},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					...
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_PROTECT, MOVE_TWINEEDLE, MOVE_METEOR_MASH, MOVE_BRICK_BREAK},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 255,
			...
			.mons = {
				{
					...
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_EARTHQUAKE, MOVE_HYDRO_PUMP, MOVE_BOUNCE, MOVE_HYPER_BEAM},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					...
					.moves = {MOVE_EXTREME_SPEED, MOVE_FIRE_BLAST, MOVE_CRUNCH, MOVE_ROCK_SMASH},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					...
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_GIGA_DRAIN, MOVE_LEECH_SEED, MOVE_TOXIC, MOVE_PROTECT},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_VILEPLUME,
					.heldItem = ITEM_PERSIM_BERRY,
					.moves = {MOVE_PSYCHIC, MOVE_STUN_SPORE, MOVE_PETAL_DANCE, MOVE_SLUDGE_BOMB},
					.hpEV = 84,
					.attackEV = 84,
					.defenseEV = 84,
					.speedEV = 84,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.heldItem = ITEM_LEFTOVERS,
					.moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_HYPNOSIS, MOVE_SWAGGER},
					.hpEV = 100,
					.attackEV = 0,
					.defenseEV = 110,
					.speedEV = 0,
				...
				},
				{
					...
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_HEADBUTT, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_GLARE},
					.hpEV = 255,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_POLIWRATH,
					.heldItem = ITEM_FIGY_BERRY,
					.moves = {MOVE_SURF, MOVE_EARTHQUAKE, MOVE_BELLY_DRUM, MOVE_ROCK_TOMB},
					.hpEV = 100,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_KANGASKHAN,
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_RETURN, MOVE_EARTHQUAKE, MOVE_ROCK_TOMB, MOVE_FAKE_OUT},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 130,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_TOXIC, MOVE_MIRROR_COAT, MOVE_RECOVER, MOVE_CONFUSE_RAY},
					.hpEV = 155,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_SANDSLASH,
					.heldItem = ITEM_SITRUS_BERRY,
					.moves = {MOVE_EARTHQUAKE, MOVE_COUNTER, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					...
					.heldItem = ITEM_WHITE_HERB,
					.moves = {MOVE_HYDRO_PUMP, MOVE_LIGHT_SCREEN, MOVE_SUPERPOWER, MOVE_RETURN},
					.hpEV = 155,
					.attackEV = 0,
					.defenseEV = 100,
					.speedEV = 0,
				...
				},
				{
					...
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_CRABHAMMER, MOVE_MUD_SHOT, MOVE_CUT, MOVE_ROCK_SMASH},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GYARADOS,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_BOUNCE, MOVE_DRAGON_DANCE, MOVE_THUNDER_WAVE, MOVE_CRUNCH},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 155,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_JYNX,
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_ICE_BEAM, MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_PSYCHIC},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 155,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_KINGDRA,
					.heldItem = ITEM_FIGY_BERRY,
					.moves = {MOVE_SURF, MOVE_DRAGON_DANCE, MOVE_BODY_SLAM, MOVE_ICE_BEAM},
					.hpEV = 110,
					.attackEV = 100,
					.defenseEV = 100,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_MANTINE,
					.heldItem = ITEM_LEFTOVERS,
					.moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_CONFUSE_RAY, MOVE_TOXIC},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_SEAKING,
					.heldItem = ITEM_FIGY_BERRY,
					.moves = {MOVE_DRILL_PECK, MOVE_MEGAHORN, MOVE_SWORDS_DANCE, MOVE_AGILITY},
					.hpEV = 255,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.heldItem = ITEM_QUICK_CLAW,
					.moves = {MOVE_EXPLOSION, MOVE_PSYCHIC, MOVE_STUN_SPORE, MOVE_GIGA_DRAIN},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
	...
	.trainers = {
	    {
			...
			.mons = {
				...
				},
				{
					...
					.moves = {MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT, MOVE_VOLT_TACKLE, MOVE_SURF},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 150,
					.speedEV = 0,
				...
				},
				{
					.species = SPECIES_JOLTEON,
					.heldItem = ITEM_BRIGHT_POWDER,
					.moves = {MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT, MOVE_DOUBLE_TEAM, MOVE_HEADBUTT},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 100,
				...
				},
				{
					.species = SPECIES_PORYGON2,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_ICE_BEAM, MOVE_ZAP_CANNON, MOVE_PSYCHIC, MOVE_RECOVER},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 125,
					.speedEV = 0,
	...
	.trainers = {
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_GYARADOS,
					.heldItem = ITEM_LIECHI_BERRY,
					.moves = {MOVE_BOUNCE, MOVE_SURF, MOVE_DRAGON_DANCE, MOVE_RETURN},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 0,
					.speedEV = 255,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_MAGNETON,
					.heldItem = ITEM_PETAYA_BERRY,
					.moves = {MOVE_THUNDER, MOVE_THUNDER_WAVE, MOVE_METAL_SOUND, MOVE_REFLECT},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 155,
					.speedEV = 255,
	...
	.trainers = {
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_AMPHAROS,
					.heldItem = ITEM_SHELL_BELL,
					.moves = {MOVE_THUNDERBOLT, MOVE_FIRE_PUNCH, MOVE_COUNTER, MOVE_BODY_SLAM},
					.hpEV = 0,
					.attackEV = 200,
					.defenseEV = 150,
					.speedEV = 0,
			...
			.mons = {
				{
					.species = SPECIES_GRANBULL,
					.heldItem = ITEM_CHOICE_BAND,
					.moves = {MOVE_RETURN, MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 55,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_MISDREAVUS,
					.heldItem = ITEM_SALAC_BERRY,
					.moves = {MOVE_SHADOW_BALL, MOVE_GRUDGE, MOVE_CONFUSE_RAY, MOVE_DESTINY_BOND},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 0,
					.speedEV = 150,
	...
	.trainers = {
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_WIGGLYTUFF,
					.heldItem = ITEM_FIGY_BERRY,
					.moves = {MOVE_LOVELY_KISS, MOVE_HYPER_VOICE, MOVE_ICE_BEAM, MOVE_ATTRACT},
					.hpEV = 0,
					.attackEV = 0,
					.defenseEV = 255,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_NIDOQUEEN,
					.heldItem = ITEM_CHOICE_BAND,
					.moves = {MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_SUPERPOWER, MOVE_SLUDGE_BOMB},
					.hpEV = 0,
					.attackEV = 255,
					.defenseEV = 155,
					.speedEV = 0,
		...
		},
		{
			...
			.mons = {
				...
				},
				{
					.species = SPECIES_NIDOKING,
					.heldItem = ITEM_CHOICE_BAND,
					.moves = {MOVE_EARTHQUAKE, MOVE_MEGAHORN, MOVE_SLUDGE_BOMB, MOVE_SURF},
					.hpEV = 0,
					.attackEV = 200,
					.defenseEV = 110,
					.speedEV = 0,
