const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_SEVII_CHAMPION]         = TRAINER_PIC_RS_BLACK_BELT,
    ...
    [FACILITY_CLASS_FALKNER]                = TRAINER_PIC_FALKNER,
    [FACILITY_CLASS_BUGSY]                  = TRAINER_PIC_BUGSY,
    [FACILITY_CLASS_WHITNEY]                = TRAINER_PIC_WHITNEY,
    [FACILITY_CLASS_MORTY]                  = TRAINER_PIC_MORTY,
    [FACILITY_CLASS_CHUCK]                  = TRAINER_PIC_CHUCK,
    [FACILITY_CLASS_JASMINE]                = TRAINER_PIC_JASMINE,
    [FACILITY_CLASS_PRYCE]                  = TRAINER_PIC_PRYCE,
    [FACILITY_CLASS_CLAIR]                  = TRAINER_PIC_CLAIR,
#ifdef BUGFIX
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_FALKNER]                = TRAINER_CLASS_JOHTO_LEADER,
    [FACILITY_CLASS_BUGSY]                  = TRAINER_CLASS_JOHTO_LEADER,
    [FACILITY_CLASS_WHITNEY]                = TRAINER_CLASS_JOHTO_LEADER,
    [FACILITY_CLASS_MORTY]                  = TRAINER_CLASS_JOHTO_LEADER,
    [FACILITY_CLASS_CHUCK]                  = TRAINER_CLASS_JOHTO_LEADER,
    [FACILITY_CLASS_JASMINE]                = TRAINER_CLASS_JOHTO_LEADER,
    [FACILITY_CLASS_PRYCE]                  = TRAINER_CLASS_JOHTO_LEADER,
    [FACILITY_CLASS_CLAIR]                  = TRAINER_CLASS_JOHTO_LEADER,
};
