...
const struct Trainer gTrainers[] = {
    ...
    [TRAINER_KSI] = {
        ...
        .trainerName = COMPOUND_STRING("JJ"), // less obvious and imho better name than 'psi' (which suggests psychic type) but it's up to you
        .doubleBattle = FALSE,
        .trainerType = TRAINER(.items = {}, .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_PREFER_STRONGEST_MOVE | AI_SCRIPT_PREFER_BATON_PASS | AI_SCRIPT_HP_AWARE,),
    ...
    [TRAINER_KINDLER] = {
        ...
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_COOL,
        .trainerPic = TRAINER_PIC_COOLTRAINER_M,
        .trainerName = COMPOUND_STRING("GUARD"),
        .doubleBattle = TRUE,
